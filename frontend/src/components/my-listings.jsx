...
const ListingCard = ({ title, type, beds, bathrooms, thumbnail, reviews, price }) => {
  return (
    <JoyCard
    ...
    <JoyCardContent>
      ...
      <Box sx={{ display: 'flex', gap: 1.5 }} >
            <JoyButton sx={{ flex: 1 }}variant="outlined" color="primary">
              Edit
            </JoyButton>
...
export const MyListings = () => {
      ...
      return (
        details.map((listing, i) => {
          ...
          return (
            ...
            <ListingCard key={i} title={listingDets.title} type={'Apartment'} beds={listingDets.metadata.beds} bathrooms={listingDets.metadata.baths} address={listingDets.address} thumbnail={listingDets.thumbnail} price={listingDets.price} reviews={listingDets.reviews} />
          )
        })
      )
    }
  ...
  return (
    <div id='my-listings'>
      <FindMyListings />
      {/* <ShowListings /> */}
      {/* {listing === 0 ? <FirstListing/> : <ShowListings/>} */}
    </div>
  );
}
